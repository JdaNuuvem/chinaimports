...
function applyCsp(response: NextResponse, nonce: string) {
  ...
  const cspDirectives = [
    ...
    `connect-src 'self'${isDev ? " ws://localhost:* http://localhost:*" : ""} ${process.env.NEXT_PUBLIC_MEDUSA_BACKEND_URL || "http://localhost:9000"} https://www.google-analytics.com https://viacep.com.br https://wa.me https://sentineltracking.io https://*.sentineltracking.io`,
